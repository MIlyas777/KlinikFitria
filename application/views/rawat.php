                            ...
                            <tr style="text-align:center;">
                                ...
                                <td style="text-align:center;">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <a href="rawat/delete_rawat?id=<?php echo htmlspecialchars($row->idrawat) ?>" title="delete" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item')"><i class="icon-trash"></i>&nbspDelete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
