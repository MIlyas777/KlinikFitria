                        ...
                        <?php foreach ($obat as $row) { ?>
                            <tr style="text-align:center;">
                                ...
                                <td style="text-align:center;">
                                    ...
                                    <a href="Obat/delete_obat?id=<?php echo htmlspecialchars($row->idobat) ?>" title="delete" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item')"><i class="icon-trash"></i>&nbspDelete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
