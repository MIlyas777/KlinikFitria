                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form action="<?php echo base_url('Tindakan/update' . $tindakan['idtindakan']) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="idtindakan" class="form-control" id="idtindakan" value="<?php echo $tindakan['idtindakan'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="namatindakan" class="form-control" id="namatindakan" value="<?php echo $tindakan['namatindakan'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" name="biaya" class="form-control" id="biaya" value="<?php echo $tindakan['biaya'] ?>">
                                    </div>
                                </div>
